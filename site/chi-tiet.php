                    ...
                    <div class="max-w-[1200px] mx-auto py-10">
                        <div class="p-5 block rounded-lg shadow-lg bg-white max-w-lg mx-auto">
                                ...
                                <form action="index.php?addcomment&product-detail&id=<?php echo $value->room_id ?>&iddm=<?php echo $value->id_category_room ?>" method="post">
                                    <div class="mb-6">
                                        <div class="flex justify-center items-center">
                                            <svg aria-hidden="true" class="w-5 h-5 text-gray-300 dark:text-gray-500 hover:text-yellow-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            ...
                            " id="" rows="3" placeholder="Nêu cảm nhận của bạn" name="content"></textarea>
                                    ...
                                    <div class="mb-6">
                                        <input type="email" class=" block w-full px-3  py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300  rounded  transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-[#0194f3] focus:outline-none" id="" placeholder="Nhập email(để nhận thông báo phản hồi)">
                                    </div>
                                    <div class="mb-6">
                                        <input type="checkbox" class="appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-[#0194f3] checked:border-[#0194f3] focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain mr-2 cursor-pointer" id="" checked>
                                        <label class="inline-block text-gray-800" for="">Gửi tôi bản sao đánh giá</label>
                                    </div>
                                    <button type="submit" class="w-full px-6 py-2.5 bg-[#0194f3] text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out" data-modal-toggle="modalEl" name="addcomment">Gửi đánh giá</button>
                                <?php endforeach ?>
                                </form>
                        </div>
                    </div>
