...
<body>
    ...
    <section class="mx-auto max-w-7xl">
        <h1 class="text-2xl font-bold text-blue-800 p-3">STAYYINN - DELUXE DOUBLE OR TWIN ROOM</h1>
        <div class="text-xl items-center pb-3 flex">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z" />
            </svg>
            <h3 class="px-2">Số 40, ngõ 80, phố Trung Kính, Phường Yên Hòa, Quận Cầu Giấy, Thành phố Hà Nội</h3>
        </div>
        <div class="grid grid-cols-3 gap-4">
            <div class="col-span-2">
                <img src="https://s3.go2joy.vn/1000w/hotel/12650/634_1663042883_6320054360dcd.jpg" alt="" class="max-width rounded">
                <div class="grid grid-cols-4 gap-4">
                    <div class="column py-3">
                        <a href=""><img src="https://s3.go2joy.vn/1000w/hotel/12650/7974_1663039837_631ff95dd1ffc.JPG" alt="" width="400"></a>
                    </div>
                    <div class="column py-3">
                        <a href=""><img src="https://s3.go2joy.vn/1000w/hotel/12650/7974_1663039837_631ff95dd1ffc.JPG" alt="" width="400"></a>
                    </div>
            ...
            <div>
                ...
                <div class="flex pb-3">
                    <p class="pr-40">Cửa sổ</p>
                    <p>20m2</p>
                </div>
                <hr>
                <h3 class="font-bold py-3">Tính năng phòng bạn thích</h3>
                <p>Máy lạnh</p>
                <p class="pb-3">Nước nóng</p>
                <hr>
                ...
                <div>
                    ...
                    <h3> <span class="text-3xl font-bold text-blue-600">900.000 VND</span> <span class="text-xl">/ phòng / đêm</span> </h3>
                </div>
                <div class="flex justify-center">
                    <button class="border border-2 rounded-md my-3 px-16 py-3 border-blue-500 text-blue-800 hover:bg-blue-500 hover:text-white">Đặt phòng</button>
                </div>
            </div>
        </div>
    </section>
    <section class="mx-auto max-w-7xl">
        <h1 class="text-2xl font-bold text-blue-800 p-3">PHÒNG LIÊN QUAN</h1>
        <div class="grid grid-cols-4 gap-8 px-1 py-3 border-b border-black">
            ...
            <div class="column">
                ...
                <h1 class="font-bold text-xl py-5">FLASHSALE ROOM</h1>
            ...
            <div class="column">
                ...
                <div class="flex">
                    <h1 class="border border-2 rounded-md my-2 border-red-500 text-red-500 font-bold">Giảm giá</h1>
            ...
            <div class="column">
                ...
                <h1><span class="font-bold pr-2 text-3xl">180.000đ</span> <span class="text-xl line-through">200.000đ</span></h1>
                <button class="border border-2 rounded-md my-3 px-8 py-3 border-blue-500 text-blue-800 hover:bg-blue-500 hover:text-white">Đặt phòng</button>
            </div>
        </div>
        <div class="grid grid-cols-4 gap-8 px-1 py-3 border-b border-black">
            <div class="column">
    ...
    <section class="mx-auto max-w-7xl">
        <h1 class="text-2xl font-bold text-blue-800 p-3">ĐÁNH GIÁ</h1>
            ...
            <div class="column">
                <div class="grid grid-cols-2 gap-4">
                    <div class="small-column py-2 flex items-center">
                        ...
                        <h1 class="text-xl px-3">09/11/2022
                            <br>
                            Khách Hàng : <span class="font-bold ">Q****h</span>
                        </h1>
                    </div>
                    <div class="small-column py-2">
                        <h1 class="text-xl px-3">Phòng: <span class="font-bold">FLASHSALE</span></h1>
                        <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-xl">Khá sạch sẽ, ổn áp , nhân viên thái độ phục vụ tốt, hình như khách sạn ko còn để su ca ba ở tủ
                    </h1>
                </div>
            </div>
            <div class="column">
