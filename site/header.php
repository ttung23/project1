<div class="nav-index containerr">
    <div class="nav-left">
        ...
        <a href=" <?= SITE_URL  ?>"><img src="../layout/assets/img/logo/30bf6c528078ba28d34bc3e37d124bdb.svg"
                alt=""></a>

    </div>
    <div class="nav-right">
        <ul>
            <li><a href=""><i class="fa-solid fa-download"></i></i> Tải ứng dụng <i><i
                            class="fa-solid fa-chevron-down"></i></i></a></li>
            ...
            <li>
                <div class="dropdown">
                    <button type="submit" id="money" class="nut_dropdown">
                        <!-- onclick="hamDropdown()" -->
                        <img src="../layout/assets/img/logo/co.png" alt="">VND<i
            ...
            <li>
                <div class="anh-dangnhap" onclick="drop_info_user()">
                    <div class="flex-anh-dn">
                        <img class="anh-user" src="../layout/assets/img/users/<?= $_SESSION['user']->images ?>"
                            width="50px" alt=""> <span><?= $_SESSION['user']->name ?></span><i
                            style="color:black; font-size: 11px; padding-left: 4px;padding-top: 5px;"
                            class="fa-solid fa-chevron-down"></i>
                    </div>
                    <div class="noidung-anh-dangnhap" id="noi_dung_info">
                        <h3>Tài khoản</h3>
                        <div class="a"><i class="fa-regular fa-user"></i> <span><a
                                    href="<?= SITE_URL . "?info-user&id=". $_SESSION['user']->user_id ?>">thông tin
                                    người dùng</a></span><br></div>
...
<div class="nav-2-index">
    <ul class="containerr">
        <li>
            <div class="menu-con4">
                <button style="margin-right: 30px;"> <a href="<?= SITE_URL . "?cart" ?>">Giỏ Hàng</a><i
                        class="fa-solid fa-caret-down"></i></button>
                <button style="margin-right: 30px;"> <a href="<?= SITE_URL . "?tin-tuc" ?>">Tin Tức</a><i
                        class="fa-solid fa-caret-down"></i></button>
                <button style="margin-right: 30px;"> <a href="<?= SITE_URL . "?list-room" ?>">Danh sách phòng</a><i
                        class="fa-solid fa-caret-down"></i></button>
