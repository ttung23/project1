<main>
            <div class="next">
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <h1 class="">
                            <i class="fa-solid fa-3 turn"></i>Thanh Toán</h1>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4">
                    ...
                    <section>
                        <div class="bg-[#EBF3FF] info">
                            <h3>
                            Bạn Đã Chọn Dịch vụ:            
                            </h3>
                            <p><i class="fa-solid fa-plus"></i>2x 2 giường đôi nhìn ra vườn</p>
                            <p><i class="fa-solid fa-plus"></i>2x 2 giường đôi nhìn ra vườn</p>
                            <p>   <i class="fa-solid fa-check turn"></i> 2 giường đôi nhìn ra vườn</p>
                            <p>   <i class="fa-solid fa-check turn"></i> 2 giường đôi nhìn ra vườn</p>
                            <p>   <i class="fa-solid fa-check turn"></i> 2 giường đôi nhìn ra vườn</p>
                            <p>   <i class="fa-solid fa-check turn"></i> 2 giường đôi nhìn ra vườn</p>
                            <h3>Bữa Ăn</h3>
                            <p><i class="fa-solid fa-plus"></i>Cả Ngày</p>
                            <h3>Số Lượng Người(Tối Đa)</h3>
                            <p><i class="fa-solid fa-plus"></i>14</p>
                            <a href="" class="btn btn-warning">Thay Đổi Lựa Chọn Của Bạn</a>
                        </div>
                    </section>
                    <section>
                        <div class="bg-[#EBF3FF] info">
                        <h1>Tóm Tắt Giá Của Bạn</h1>
                        <div>
                            <div>
