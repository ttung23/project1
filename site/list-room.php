        ...
        <div class="right-l-pro">
            ...
            <div class="tim-r-pro">
                ...
                <select name="tp" id="sampleSelect" class="tp" onchange="location = this.value;">
                    ...
                    <?php foreach ($categoriesAll as $key => $value) : ?>
                    <option
                        value="index.php?list-room&id=<?php echo $value->categories_id; ?>&iddm=<?php echo $value->categories_id; ?>">
                ...
                <div class="img-l-pro">
                    <div class="nd-img-room">
                        ...
                        <div class="nd-flex-room">
                            ...
                            <a href="">Khách sạn</a><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i
                                class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i
                                class="fa-solid fa-star"></i> <br />
                            <i style="padding-top: 13px; padding-right: 7px; color: #959ca1"
                                class="fa-solid fa-location-dot"></i><span style="color: #959ca1">Hà nội</span><br />
                            <i style="color: #1ba0e2; padding-top: 9px" class="fa-solid fa-heart"></i>
                            <span style="color: #1ba0e2">ấn tượng - 8.9</span> (257)
                            <br /><br />
                            <a style="background-color: #eac2b0; color: #616669" href=""><i style="color: #f3545c"
                                    class="fa-solid fa-gift"></i> Quà
                  ...
                  ">
                        ...
                        <a href="<?= SITE_URL . "?product-detail&id=$value->room_id&iddm=$value->id_category_room" ?>">Đặt
                            phòng</a>
                    </div>
                </div>
            </div>
            ...
            <?php foreach ($selectfind as $key => $value) : ?>
                <div class="room-l-pro">
                    <div class="img-l-pro">
                        ...
                        margin-top: 50px;
                    ">
                                <?php echo number_format($value->price, 0, ",", ".") ?><span>đ</span>
                            </span>
                            <br />
                            <br />
                            <a href="<?= SITE_URL . "?product-detail&id=$value->room_id&iddm=$value->id_category_room" ?>">Đặt
