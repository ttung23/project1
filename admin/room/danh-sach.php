        ...
        <div class="pb-4 m-4">
            ...
            <div class="my-4 row">
                ...
                <div class="col-sm-2 m-4 hover-bg-[#78C2B5]">
                    <div>
                        <a href="c_room.php" class="border btn btn-outline-success border-[#D0D7DE] w-100 h-100 text-primary px-3 py-1 shadow-lg">
                            Tất Cả
                        </a>
                    </div>
                </div>
                <div class="col-sm-2 m-4 hover-bg-[#78C2B5]">
                    <div>
                        <a href="c_room.php?id=0" class="border btn btn-outline-success border-[#D0D7DE] w-100 h-100 text-primary px-3 py-1 shadow-lg">
                            Phòng Đang Sửa
                        </a>
                    </div>
                </div>
                <div class="col-sm-2 m-4 hover-bg-[#78C2B5]">
                    <div>
                        <a href="c_room.php?id=1" class="border btn btn-outline-success border-[#D0D7DE] w-100 h-100 text-primary px-3 py-1 shadow-lg">
                            Phòng Kích Hoạt
                        </a>
                    </div>
                </div>
                <div class="col-sm-2 m-4 hover-bg-[#78C2B5]">
                    <div>
                        <a href="c_room.php?id=2" class="border btn btn-outline-success border-[#D0D7DE] w-100 h-100 text-primary px-3 py-1 shadow-lg">
                            Phòng Phòng Khóa
                        </a>
                    </div>
                </div>
                <div class="col-sm-2 m-4">
                    <form action="" method="post">
                        <div>
                            <a class="border border-[#D0D7DE] btn btn-outline-warning btn btn-outline-danger w-100 h-100 text-primary px-3 py-1 shadow-lg">
                ...
                <div class="col-sm-2 m-4">
                    <div>
                        <a href="c_room.php?add-room" class="border border-[#D0D7DE] btn btn-outline-warning btn btn-outline-danger w-100 h-100 text-primary px-3 py-1 shadow-lg">
                            <i class="fa-solid fa-person-walking-luggage text-success"></i>
                            Thêm
                        </a>
                    </div>
                ...
                <div class="col-sm-2 m-4">
                    ...
                    <div>
                        <button type="submit" name="delete_room" onclick="return confirm('Bạn muốn xóa danh mục ko?')" class="border border-[#D0D7DE] btn btn-outline-warning btn btn-outline-danger w-100 h-100 text-primary px-3 py-1 shadow-lg">
                            <i class="fa-solid fa-person-walking-luggage text-success"></i>
                            Xóa
                        </button>
                    </div>
                ...
                <div class="col-sm-2 m-4">
                    ...
                    <div>
                        <button type="submit" name="lock_room"  class="border border-[#D0D7DE] btn btn-outline-warning btn btn-outline-danger w-100 h-100 text-primary px-3 py-1 shadow-lg">
                            <i class="fa-solid fa-person-walking-luggage text-success"></i>
                            Khóa
                        </button>
                    </div>
                ...
                <div class="col-sm-2 m-4">
                    ...
                    <div>
                        <button type="submit" name="unlock_room" class="border border-[#D0D7DE] btn btn-outline-warning btn btn-outline-danger w-100 h-100 text-primary px-3 py-1 shadow-lg">
                            <i class="fa-solid fa-person-walking-luggage text-success"></i>
                            Mở Khóa
                        </button>
                    </div>
                ...
                <?php foreach ($loadone as $key => $value) : ?>
                    <div class="col-sm-1  py-2 text-center py-5 h-25 w-25 <?php if ($value->status == 1) {
                        ...
                        <td><input type="checkbox" name="room[]" class="rounded" value="<?= $value->room_id ?>" />
                            <a href="c_room.php?edit-room&id=<?php echo $value->room_id ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                            <a type="submit" name="addbooking" data-modal-toggle="popup-modal<?= $value->room_id ?>"><i class="fa-solid fa-eye"></i></a>
    ...
    <?php foreach ($loadone as $key => $value) : ?>
        ...
        <div id="popup-modal<?= $value->room_id ?>" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 p-4 md:inset-0 h-modal md:h-full">
            ...
            <div class="thanhtoan_tc" style="background-color:white">
                <div class="flex_tt">
                    <img src="assets/img/icon/images.png" alt="">
                    <h2>Stayyin</h2>
                </div>
                <div class="tt_qr">
