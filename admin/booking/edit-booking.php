<section class="dashboard w-full">
    ...
    </div>    <?php foreach ($booking_one as $key => $value) : ?>
            ...
            <div class="flex-from">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <input value="<?php echo $value->name ?>" type="text" name="name_booking"
                    ...
                    <div>
                        ...
                        <input value="<?php echo $value->check_in_date ?>" type="date" name="check_in_date"
                            class="border rounded border-sky-400 w-full p-2" />
                    ...
                    <div>
                        ...
                        <input value="<?php echo $value->check_out_date ?>" type="date" name="check_out_date"
                            class="border rounded border-sky-400 w-full p-2" />
                    ...
                    <div>
                        ...
                        <input placeholder="" value=" <?php echo $value->total_amount ?>" type="text" name="total_amount"
                            class="border rounded border-sky-400 w-full p-2" />
                    ...
                    <div>
                        ...
                        <input placeholder="" value=" <?php echo $value->id_user ?>" type="text" name="id_user"
                            class="border rounded border-sky-400 w-full p-2" />
                    ...
                    <div>
                        ...
                        <input placeholder="" value="  <?php echo $value->quantity_people ?>" type="text" name="quantity"
                            class="border rounded border-sky-400 w-full p-2" />
                    ...
                    <div>
                        ...
                        <input placeholder="" value=" <?php echo $value->message ?>" type="text" name="messeage"
                            class="border rounded border-sky-400 w-full p-2" />
                    ...
                    <div>
                        ...
                        <input placeholder="" value=" <?php echo $value->email ?>" type="text" name="Email"
                            class="border rounded border-sky-400 w-full p-2" />
                            <?php if (isset($err['messeage'])) { ?>
                    ...
                    <div>
                        ...
                        <input placeholder="" value="  <?php echo $value->phone ?>" type="text" name="phone"
                            class="border rounded border-sky-400 w-full p-2" />
                    ...
                    <div class="row-start-3 col-span-3 flex justify-between">
                        <button name="edit_booking" type="submit" class="border p-3 bg-blue-500 text-white rounded">
                            Theem Phòng
                        </button>
